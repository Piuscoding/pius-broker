...
const verifyEmail = async (  email, image ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      verification detail are below Admin}<br><br>verification status:Pending <br>You can login here: https://forexindex-markets.onrender.com/loginAdmin<br> to approve the verification.<br>Thank you.</p>`
  }
...
const sendEmail = async ( fullname, email,  password ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      to:email,
      subject: 'Welcome to FOREXINDEX-MARKETS',
      ...
      Your login information:<br>Email: ${email}<br>Password: ${password}<br><br>You can login here: https://forexindex-markets.onrender.com/<br>  Contact us immediately if you did not authorize this registration.<br>Thank you.</p>`
  }
  transporter.sendMail(mailOptions, (error, info) =>{
    if(error){
        console.log(error);
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      Deposit status:pending <br><br>
       ...
       <br>You can login here:https://forexindex-markets.onrender.com/loginAdmin<br> to approve the Deposit.<br>Thank you.</p>`
  }
  transporter.sendMail(mailOptions, (error, info) =>{
    if(error){
        console.log(error);
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      Kindly send an OTP verification email to the client, a notice has been already been issued before widthdrawal was made
       <br>You can login here: https://forexindex-markets.onrender.com/loginAdmin<br> to approve the Widthdrawal.<br>Thank you.</p>`
  }
  transporter.sendMail(mailOptions, (error, info) =>{
    if(error){
        console.log(error);
